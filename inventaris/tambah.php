...
/** Nama barang: hanya huruf + spasi, TIDAK boleh mengandung angka */
function validasiNamaBarang(string $nilai): string|false
{
    $nilai = trim($nilai);
    if ($nilai === '') return false;
    if (preg_match('/\d/', $nilai)) return false;                        // tolak jika ada digit
    if (!preg_match('/^[\p{L}\s.,\-\'\/()]+$/u', $nilai)) return false; // hanya huruf unicode & spasi
    if (mb_strlen($nilai) < 2 || mb_strlen($nilai) > 150) return false;
    return $nilai;
}

/** Kode barang: alfanumerik, tanda hubung, garis bawah */
...
/** Keterangan: strip tag, batasi 500 karakter */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 8. Keterangan (opsional)
    $data['keterangan'] = validasiKeterangan($_POST['keterangan'] ?? '');

    // 9. Cek duplikat kode — PREPARED STATEMENT
    if (!isset($errors['kode_barang'])) {
        $stmtCek = $conn->prepare("SELECT id_barang FROM barang WHERE kode_barang = ?");
        $stmtCek->bind_param('s', $data['kode_barang']);
        $stmtCek->execute();
    ...
    // 10. Upload Foto (wajib saat tambah)
    $nama_foto = null;
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] === 0) {
        ...
        $errors['foto'] = 'Foto barang wajib diunggah.';
    }

    // 11. Simpan — PREPARED STATEMENT
    if (empty($errors)) {
...
<div class="container" style="max-width:700px">
    <div class="card p-4">
        ...
        <form id="formTambah" method="POST" enctype="multipart/form-data" novalidate>
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_barang" id="kode_barang"
                           ...
                           value="<?= htmlspecialchars($data['kode_barang']) ?>" placeholder="Contoh: BRG001" maxlength="50">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang"
                           ...
                           value="<?= htmlspecialchars($data['nama_barang']) ?>" placeholder="Nama lengkap barang" maxlength="150">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="harga_beli" id="harga_beli"
                           ...
                           min="1" value="<?= htmlspecialchars($data['harga_beli']) ?>" placeholder="0">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="harga_jual" id="harga_jual"
                           ...
                           min="1" value="<?= htmlspecialchars($data['harga_jual']) ?>" placeholder="0">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="jumlah" id="jumlah"
                           ...
                           min="0" value="<?= htmlspecialchars($data['jumlah']) ?>" placeholder="0">
                ...
                <div class="col-12">
                    ...
                    <textarea name="keterangan" id="keterangan" class="form-control" rows="3"
                              maxlength="500" placeholder="Deskripsi tambahan (opsional)"><?= htmlspecialchars($data['keterangan']) ?></textarea>
...
$('#formTambah').validate({
    rules: {
        ...
        foto:          { required: true, accept: 'image/jpeg|image/png|image/gif|image/webp' }
    },
    messages: {
        ...
        foto:          { required: 'Foto barang wajib diunggah.', accept: 'Format harus JPG, PNG, GIF, atau WEBP.' }
    },
